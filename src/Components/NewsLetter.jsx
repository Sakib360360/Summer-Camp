                            ...
                            <div className="flex flex-wrap -mx-4 items-center">
                                <div className="w-full lg:w-full px-4 mb-16 lg:mb-0">
                                    <div className=" max-w-lg mx-auto">
                                        <h4 className="font-heading text-4xl sm:text-5xl lg:text-6xl  font-bold mb-6">Sign up for our newsletter</h4>
                                        ...
                                        <div className="sm:flex items-center">
                                            <input className="w-full mb-3 sm:mb-0 sm:mr-4 py-3 px-4 text-sm text-gray-900 placeholder-gray-400 border border-gray-200 focus:border-purple-500 focus:outline-purple rounded-lg" type="email" placeholder="pat@saturn.dev" />
                                                <button className=" group inline-block flex-shrink-0 w-full sm:w-auto py-3 px-5 text-sm font-semibold text-orange-50 bg-orange-900 rounded-md overflow-hidden" type="submit">
                                                    <div className="  right-full w-full h-full bg-gray-900 transform group-hover:translate-x-full group-hover:scale-102 transition duration-500"></div>
